...
const reels = [
  {
    ...
    title: 'AI Cybersecurity: smarter defense in seconds',
    desc: 'A fast AI + cybersecurity lesson showing how artificial intelligence can help identify threats, improve awareness, and make security easier to understand.',
    creator: '@youtubecreator', badge: 'Playable YouTube Short', duration: 'Short', xp: 30,
  ...
  },
  {
    ...
    desc: 'Understand the basics of a Virtual Private Cloud: private networking, subnets, routing, and controlled cloud access.',
  ...
  },
  {
    ...
    desc: 'Discover AI tools that can help students research faster, organize notes, study smarter, and build better assignments with verification.',
  ...
  },
  {
    ...
    desc: 'A motivation-focused coding lesson: build small challenges, earn progress, and make programming feel like leveling up.',
...
function youtubeEmbed(reel) {
  return `https://www.youtube.com/embed/${reel.videoId}?autoplay=1&mute=1&playsinline=1&controls=1&modestbranding=1&rel=0&playsinline=1&enablejsapi=1&origin=${encodeURIComponent(location.origin)}`;
}
function persist() {

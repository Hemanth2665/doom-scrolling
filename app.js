...
const reels = [
  {
    id: 'ai-prompt-formula', localSrc: 'assets/videos/ai_prompt_formula.mp4', poster: 'assets/posters/ai_prompt_formula.jpg', topic: 'AI', videoId: '_cs2YZ2QFBY', source: 'youtube',
    title: 'The AI prompt formula that actually works',
    desc: 'Use role, goal, context, and output format so AI gives clear results instead of generic answers.',
    creator: '@promptlab', badge: 'Education Reel', duration: '0:38', xp: 25,
    likes: 18400, comments: 892, saves: 4200,
    quiz: 'What makes an AI prompt stronger?', options: ['Role + goal + context + format', 'One vague sentence', 'Only emojis'], answer: 'Role + goal + context + format',
    summary: 'Prompting works better when you include role, goal, context, and the output format.'
  },
  {
    id: 'ai-student-tools', localSrc: 'assets/videos/ai_prompt_formula.mp4', poster: 'assets/posters/ai_prompt_formula.jpg', topic: 'AI', videoId: 'K1-B_7a3Sxg', source: 'youtube',
    title: 'AI tools students should try',
    desc: 'Use AI for research, notes, presentations, and practice. The key is to verify facts before submitting work.',
    creator: '@studentai', badge: 'Education Reel', duration: '0:42', xp: 18,
    likes: 26100, comments: 1040, saves: 7200,
    quiz: 'What should students do with AI output?', options: ['Verify important facts', 'Copy blindly', 'Never edit it'], answer: 'Verify important facts',
    summary: 'AI tools can help with notes, research, and presentations, but important facts still need verification.'
  },
  {
    id: 'cyber-2fa', localSrc: 'assets/videos/cyber_2fa.mp4', poster: 'assets/posters/cyber_2fa.jpg', topic: 'Cyber', videoId: 'AiXVxYZ7Go8', source: 'youtube',
    title: 'Password managers and 2FA explained',
    desc: 'Stop reusing passwords. A password manager plus two-factor authentication gives accounts a stronger defense.',
    creator: '@cyberminute', badge: 'Education Reel', duration: '0:44', xp: 30,
    likes: 22100, comments: 1200, saves: 6400,
    quiz: 'What is safer than reusing one password?', options: ['Password manager + 2FA', 'Same password everywhere', 'Saving passwords in notes'], answer: 'Password manager + 2FA',
    summary: 'Account safety improves when you stop reusing passwords and add two-factor authentication.'
  },
  {
    id: 'agent-memory', localSrc: 'assets/videos/agents_memory.mp4', poster: 'assets/posters/agents_memory.jpg', topic: 'AI', videoId: 'z6sgRN4t_cw', source: 'youtube',
    title: 'AI agent memory: short-term vs long-term',
    desc: 'AI agents become more useful when they can remember task context now and useful information later.',
    creator: '@agentstack', badge: 'Education Reel', duration: '0:50', xp: 28,
    likes: 14800, comments: 740, saves: 5100,
    quiz: 'Why does memory matter for AI agents?', options: ['It helps agents keep context', 'It removes all safety controls', 'It makes prompts unnecessary'], answer: 'It helps agents keep context',
    summary: 'AI agents use memory to keep task context and improve across interactions.'
  },
  {
    id: 'cloud-vpc', localSrc: 'assets/videos/cloud_vpc.mp4', poster: 'assets/posters/cloud_vpc.jpg', topic: 'Cloud', videoId: 'GHTvTHFJRC8', source: 'youtube',
    title: 'Amazon VPC in under a minute',
    desc: 'A VPC is your private network space in the cloud, where you control subnets, routing, and access.',
    creator: '@cloudnotes', badge: 'Education Reel', duration: '0:39', xp: 24,
    likes: 9100, comments: 330, saves: 2700,
    quiz: 'What is a VPC?', options: ['Private network in the cloud', 'A spreadsheet tool', 'A password app'], answer: 'Private network in the cloud',
    summary: 'A VPC is an isolated cloud network where teams control routing, subnets, and access.'
  },
  {
    id: 'study-active-recall', localSrc: 'assets/videos/study_recall.mp4', poster: 'assets/posters/study_recall.jpg', topic: 'Study', videoId: 'j7vAF-OrOAQ', source: 'youtube',
    title: 'Active recall beats rereading',
    desc: 'Close the notes and test yourself from memory. Retrieval practice helps learning stick longer.',
    creator: '@studybetter', badge: 'Education Reel', duration: '0:32', xp: 20,
    likes: 39400, comments: 1700, saves: 9800,
    quiz: 'What is active recall?', options: ['Testing yourself from memory', 'Rereading the same page', 'Highlighting everything'], answer: 'Testing yourself from memory',
    summary: 'Active recall means testing yourself from memory instead of only rereading notes.'
  },
  {
    id: 'finance-compound', localSrc: 'assets/videos/finance_compound.mp4', poster: 'assets/posters/finance_compound.jpg', topic: 'Finance', videoId: 'YBtUORDsDVk', source: 'youtube',
    title: 'Compound interest made simple',
    desc: 'Compounding happens when your gains start earning gains. Time is the most powerful part of the equation.',
    creator: '@financialliteracy', badge: 'Education Reel', duration: '0:52', xp: 18,
    likes: 28700, comments: 910, saves: 6700,
    quiz: 'Why is compounding powerful?', options: ['Gains can earn more gains', 'It only works for one day', 'It removes risk completely'], answer: 'Gains can earn more gains',
    summary: 'Compound interest grows when gains are reinvested and time does more of the work.'
  },
  {
    id: 'career-star', localSrc: 'assets/videos/career_star.mp4', poster: 'assets/posters/career_star.jpg', topic: 'Career', videoId: 'XhLwK62-KZo', source: 'youtube',
    title: 'Use the STAR method in interviews',
    desc: 'Structure answers with Situation, Task, Action, and Result so your experience sounds clear and measurable.',
    creator: '@careercoach', badge: 'Education Reel', duration: '0:41', xp: 22,
    likes: 15800, comments: 640, saves: 4900,
    quiz: 'What does STAR help with?', options: ['Structured interview answers', 'Password storage', 'Cloud routing'], answer: 'Structured interview answers',
    summary: 'STAR structures interview stories with situation, task, action, and result.'
  },
  {
    id: 'prompt-google', localSrc: 'assets/videos/ai_prompt_formula.mp4', poster: 'assets/posters/ai_prompt_formula.jpg', topic: 'AI', videoId: 'CWMEA7GS_g4', source: 'youtube',
    title: 'Prompt engineering in AI',
    desc: 'Clear prompts help AI understand the job, constraints, and expected output before it answers.',
    creator: '@googlecareer', badge: 'Education Reel', duration: '0:35', xp: 23,
    likes: 17600, comments: 760, saves: 5400,
    quiz: 'What does prompt engineering improve?', options: ['AI instructions and output quality', 'Battery life', 'DNS speed'], answer: 'AI instructions and output quality',
    summary: 'Prompt engineering improves AI output by giving clearer instructions and expectations.'
  },
  {
    id: 'premium-sql-joins', localSrc: 'assets/videos/premium_sql.mp4', poster: 'assets/posters/premium_sql.jpg', topic: 'Premium', videoId: '9lKn1f2Ng6g', source: 'youtube', premium: true,
    title: 'Premium lab: SQL joins in 60 seconds',
    desc: 'Learn how inner, left, right, and full joins combine related data across database tables.',
    creator: '@simplilearn', badge: 'Premium preview', duration: '1:00', xp: 40,
    likes: 30500, comments: 2200, saves: 8900,
    quiz: 'What do SQL joins do?', options: ['Combine related table data', 'Encrypt a phone', 'Create a domain name'], answer: 'Combine related table data',
    summary: 'SQL joins combine rows from related tables using matching columns.'
  }
];
...
function youtubeEmbed(reel) {
  return `https://www.youtube.com/embed/${reel.videoId}?autoplay=1&mute=1&playsinline=1&controls=0&modestbranding=1&loop=1&playlist=${reel.videoId}&rel=0`;
}
function persist() {
...
function localVideoFor(reel) {
  const fallback = localFallbacks.find(item => item.topic === reel.topic) || localFallbacks[0];
  return `assets/videos/${fallback.file}`;
}
...
function reelTemplate(reel) {
  ...
  const sourceLabel = reel.premium ? 'Premium Education Reel' : 'Education Reel';
  const bg = reel.localSrc ? '' : `style="background-image:url('${thumbUrl(reel)}')"`;
  const media = `<div class="thumb-bg" ${bg}></div><video class="local-video" src="${clean(reel.localSrc || localVideoFor(reel))}" poster="${thumbUrl(reel)}" muted loop playsinline preload="metadata"></video>`;
...
function init() {
  ...
  bindEvents(); updateTime(); setInterval(updateTime, 30000);
}
init();
